...
$sql_ovn_01 = sqlsrv_query($conS, "
			SELECT
    a.no_mesin,    
    SUM(CASE WHEN (a.kondisi_kain = 'BASAH') and  (a.shift= 'A' or a.shift= 'B' or a.shift= 'C')  THEN a.qty ELSE 0 END) AS kg,
    SUM(CASE WHEN (a.kondisi_kain = 'BASAH') and  (a.shift= 'A' or a.shift= 'B' or a.shift= 'C')  THEN a.panjang ELSE 0 END) AS yard
FROM
	db_finishing.tbl_produksi a
LEFT JOIN db_finishing.tbl_no_mesin b ON
	a.no_mesin = b.no_mesin
...
$rowd_stmr = sqlsrv_fetch_array($sql_stmr, SQLSRV_FETCH_ASSOC);			
		?>
          ...
          <tr>
            ...
            <td colspan="3" align="center" bgcolor="#7F9DF0">&nbsp;</td>
            </tr>
          <tr>
