...
$Awal = $_GET['awal'];
$Akhir = $_GET['akhir'];
$qTgl = sqlsrv_query($cond, "
  SELECT
    CONVERT(varchar(10), GETDATE(), 120) AS tgl_skrg,
        ...
        border-right:0px #000000 solid;">
          <table width="100%" border="0" class="table-list1">
            <tr>
              ...
              border-bottom:0px #000000 solid;
              border-left:0px #000000 solid; 
              border-right:0px #000000 solid;"><strong>
                  <font size="+1">LAPORAN HARIAN COCOK WARNA DEPARTEMEN CQA</font><br />
                  <font size="-1">FW-12-CQA-06/00</font>
            </tr>
          </table>
        </td>
      </tr>
          ...
          <table width="100%" border="1" class="table-list1">
            <tr>
              <td align="left" valign="bottom"><strong>
                  <font size="-1">Tanggal : <?php echo date("d F Y", strtotime($_GET['awal'])) . " " . $jamA; ?></font><br />
        ...
        <table width="100%" border="1" class="table-list1">
          <thead>
            <tr align="center">
              ...
              <td rowspan="2">
                <font size="-2"><strong>Tgl Fin</strong></font>
              </td>
              <td rowspan="2">
                <font size="-2"><strong>No Demand</strong></font>
              </td>
              <td rowspan="2">
              ...
              <td rowspan="2">
                <font size="-2"><strong>Item</strong></font>
              </td>
              <td rowspan="2">
              ...
              <td rowspan="2">
                <font size="-2"><strong>No Warna</strong></font>
              </td>
              <td rowspan="2">
                <font size="-2"><strong>Lot</strong></font>
              </td>
              <td colspan="2">
                <font size="-2"><strong>Bruto</strong></font>
              </td>
              <td rowspan="2">
                <font size="-2"><strong>Shift</strong></font>
              </td>
              <td rowspan="2">
                <font size="-2"><strong>Status Warna</strong></font>
              </td>
              <td rowspan="2">
                <font size="-2"><strong>Code Proses</strong></font>
              </td>
              <td rowspan="2">
                <font size="-2"><strong>Colorist</strong></font>
              </td>
              <td rowspan="2">
                <font size="-2"><strong>Tgl Celup</strong></font>
              </td>
              <td rowspan="2">
            ...
            <tr align="center">
              <td>
                <font size="-2"><strong>Jml Rol</strong></font>
              </td>
              <td>
                <font size="-2"><strong>Qty (Kgs)</strong></font>
              </td>
            </tr>
          </thead>
          <tbody>
            ...
            $qry1 = sqlsrv_query($cond, "
                ...
                WHERE CONVERT(datetime,
                        ...
                        120
                      ) BETWEEN CONVERT(datetime, '$start_date', 120)
                          AND CONVERT(datetime, '$stop_date', 120)
                  AND dept = 'QCF'
                  $shft
                ORDER BY id ASC
              ");
            ...
            ?>
              <tr valign="top">
                ...
                <td align="center">
                  <font size="-2">
                    <?php
                    $tgl = $row['tgl_update'] ?? null;
                    echo ($tgl instanceof DateTime) ? $tgl->format('Y-m-d') : $tgl;
                    ?>
                  </font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['nodemand']; ?></font>
                </td>
                <td>
                  <font size="-2"><?php echo substr($row['pelanggan'], 0, 7) . " " . substr($row['pelanggan'], 7, 40); ?></font>
                </td>
                <td>
                  <font size="-2"><?php echo substr($row['no_po'], 0, 10) . " " . substr($row['no_po'], 10, 20) . " " . substr($row['no_po'], 20, 40); ?></font>
                </td>
                <td>
                  <font size="-2"><?php echo $row['no_order']; ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['no_item']; ?></font>
                </td>
                <td>
                  <font size="-2"><?php echo $row['jenis_kain']; ?></font>
                </td>
                <td>
                  <font size="-2"><?php echo substr($row['warna'], 0, 15) . " " . substr($row['warna'], 15, 50); ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo substr($row['no_warna'], 0, 10) . " " . substr($row['no_warna'], 10, 50); ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['lot']; ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['jml_roll']; ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['bruto']; ?><font size="-2">
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['shift']; ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['status']; ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['proses']; ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['colorist_qcf']; ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['tgl_pengiriman']; ?></font>
                </td>
                <td align="center">
                  <font size="-2"><?php echo $row['catatan']; ?></font>
                </td>
              </tr>
            <?php
              if ($row['proses'] == "Fin") {
