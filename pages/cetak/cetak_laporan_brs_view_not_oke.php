...
<table border="0" class="table-list1" width="100%">
  <tbody>
    <tr>
      ...
      <td width="95%" align="center" valign="middle"><font size="+2"><strong>LAPORAN PRODUKSI HARIAN DEPARTEMEN BRUSHING</strong></font></td>
    </tr>
  </tbody>
</table>
    ...
    <tr>
	  ...
	  <?php
                ...
                foreach ($dateRange as $date) {
                    ...
                    echo "<tr>";
                    echo "<td style='border: 1px solid black;' align='center'>{$tanggal1}</td>";
                ...
                ?>
            <td style='border: 1px solid black;' align='center' colspan=""><strong>Total</strong></td>
                <?php
  ...
  <tbody>
    <tr>
	  ...
	  <?php
                ...
                // Tanggal sehari sebelumnya jam 23:01:00
		...
		<table border="0" class="table-list1" width="100%">
                ...
                <tr>
                    ...
                    // $total_qty_garukfleece = ($row_garuk_fleece['TOTAL_QTY'] ?? 0) - ($row_garuk_greige['qty_garuk_fleece_tambah_obat'] ?? 0);
					   $total_kk_garukfleece = (($row_garuk_fleece['JUMLAHKK']+$row_qty_sisa['garuk_fleece_lot']) ?? 0) - ($row_garuk_greige['jumlah_kk'] ?? 0);
                       $total_qty_garukfleece = (($row_garuk_fleece['TOTAL_QTY']+$row_qty_sisa['garuk_fleece']) ?? 0) - ($row_garuk_greige['qty_garuk_fleece_tambah_obat'] ?? 0);
                    ?>
                ...
                <tr>
                    ...
                    // $total_qtybulu = ($row_potongbulu['TOTAL_QTY'] ?? 0) - ($row_potongbulu_lainlain['qty_potongbulu_lain_lain'] ?? 0);
                     $total_kk_potongbulu = (($row_potongbulu['JUMLAHKK']+$row_qty_sisa['potong_bulu_fleece_lot']) ?? 0) - ($row_potongbulu_lainlain['jumlah_kk'] ?? 0);
                     $total_qtybulu = (($row_potongbulu['TOTAL_QTY']+$row_qty_sisa['potong_bulu_fleece']) ?? 0) - ($row_potongbulu_lainlain['qty_potongbulu_lain_lain'] ?? 0);
                    ?>
                ...
                <tr>
                    ...
                    // $total_qty_garuk_kain_fleece = ($row_garuk_anti_pilling['TOTAL_QTY'] ?? 0) - ($row_garuk_fleece_tambah_obat['qty_garuk_fleece_tambah_obat'] ?? 0);
                     $total_kk_garuk_kain_fleece = (($row_garuk_anti_pilling['JUMLAHKK']+$row_qty_sisa['garuk_anti_pilling_lot']) ?? 0) - ($row_garuk_fleece_tambah_obat['jumlah_kk'] ?? 0);
                     $total_qty_garuk_kain_fleece = (($row_garuk_anti_pilling['TOTAL_QTY']+$row_qty_sisa['garuk_anti_pilling']) ?? 0) - ($row_garuk_fleece_tambah_obat['qty_garuk_fleece_tambah_obat'] ?? 0);
                    ?>
                    <td style="text-align:center;">
                ...
                <tr>
                    ...
                    // $total_qty_potongbulu_lainlain = ($row_potongbulu['TOTAL_QTY'] ?? 0) - ($row_potongbulu_lainlain['qty_potongbulu_lain_lain'] ?? 0);
                     $total_kk_potongbulu_lainlain = (($row_potongbulu['JUMLAHKK']+$row_qty_sisa['potong_bulu_lain_lain_lot']) ?? 0) - ($row_potongbulu_lainlain['jumlah_kk'] ?? 0);
                     $total_qty_potongbulu_lainlain = (($row_potongbulu['TOTAL_QTY']+$row_qty_sisa['potong_bulu_lain_lain']) ?? 0) - ($row_potongbulu_lainlain['qty_potongbulu_lain_lain'] ?? 0);
                    ?>
                    <td style="text-align:center;">
                ...
                <tr>
                    ...
                    // $total_qty_peachskin = ($rowpeachskin['TOTAL_QTY'] ?? 0) - ($row_peach['qty_peach'] ?? 0);
                     $total_kk_peachskin = (($rowpeachskin['JUMLAHKK']+$row_qty_sisa['peach_skin_lot']) ?? 0) - ($row_peach['jumlah_kk'] ?? 0);
                     $total_qty_peachskin = (($rowpeachskin['TOTAL_QTY']+$row_qty_sisa['peach_skin']) ?? 0) - ($row_peach['qty_peach'] ?? 0);
                    ?>
                    <td style="text-align:center;">
                        <?= $total_kk_peachskin; ?>
                    </td>
                ...
                <tr>
                    <td><strong>OVEN ANTI PILLING LAIN-LAIN</strong></td>
                    <td style="text-align:center;">0</td>
                    <td style="text-align:center;">0.00</td>
                </tr>
                <tr>
...
<!-- Tabel-5.php -->
        ...
        <table border="0" class="table-list1" width="100%">
            ...
            <!--            <td align="center"><?= htmlspecialchars($total_tidak_tercapai_30_jam_libur); ?></td>-->
                ...
                <td align="center">
                    <?php
                    $sisakartu_kerja_biasa = max(0,$total_KARTU_KERJA_BIASA - ($total_tercapai_30_jamDOM+$total_not_achieved_DOM)) ;
                ...
                <td align="center">
                    ...
                    if ($total_KARTU_KERJA_BIASA > 0) {
                        $persentase_tidak_tercapai_proses = ($total_not_achieved_DOM / ($total_KARTU_KERJA_BIASA)) * 100;
                ...
                <td align="center">
                    <?php
                    if ($total_KARTU_KERJA_BIASA > 0) {
                        $percentage = ($sisakartu_kerja_biasa / $total_KARTU_KERJA_BIASA) * 100;
				...
				<td align="center"><?php
                    if ($total_KARTU_KERJA_BIASA > 0) {
                        $percentage_tercapai = ($total_tercapai_30_jamDOM / $total_KARTU_KERJA_BIASA) * 100;
            ...
            <!--            <td align="center"><?= htmlspecialchars($total_tidak_tercapai_12_jam_liburREP) ?? 0; ?></td>-->
                ...
                <td align="center">
                    <?php
                    $sisakartu_kerja_ganti_kain = max(0,$total_GANTI_KAIN_EKSTERNAL - ($total_tercapai_12_jamREP+$total_not_achieved_REP));
                ...
                <td align="center">
                    <?php
                    if ($total_GANTI_KAIN_EKSTERNAL > 0) {
                        $persentase_tidak_tercapai_prosesREP = ($total_not_achieved_REP / $total_GANTI_KAIN_EKSTERNAL) * 100;
                ...
                <td align="center">
                    <?php
                    if ($total_GANTI_KAIN_EKSTERNAL > 0) {
                        $percentageREP = ($sisakartu_kerja_ganti_kain / $total_GANTI_KAIN_EKSTERNAL) * 100;
				...
				<td align="center"><?php
                    if ($total_GANTI_KAIN_EKSTERNAL > 0) {
                        $percentageREP_tercapai = ($total_tercapai_12_jamREP / $total_GANTI_KAIN_EKSTERNAL) * 100;
            ...
            <!--            <td align="center"><?= htmlspecialchars($total_tidak_tercapai_12_jam_hari_liburMBE) ?? 0; ?></td>-->
                ...
                <td align="center">
                    <?php
                    $sisakartu_kerja_mini_bulk = max(0,$total_MINI_BULK - ($total_tercapai_12_jamMBE+$total_not_achieved_MBE));
                ...
                <td align="center">
                    <?php
                    if ($total_MINI_BULK > 0) {
                        $persentase_tidak_tercapai_prosesMBE = ($total_not_achieved_MBE / $total_MINI_BULK) * 100;
                ...
                <td align="center">
                    <?php
                    if ($total_MINI_BULK > 0) {
                        $percentage_mini_bulk = ($sisakartu_kerja_mini_bulk / $total_MINI_BULK) * 100;
				...
				<td align="center"><?php
                    if ($total_MINI_BULK > 0) {
                        $percentage_mini_bulk_tercapai = ($total_tercapai_12_jamMBE / $total_MINI_BULK) * 100;
            ...
            <!-- <td align="center"><?= htmlspecialchars($total_tidak_tercapai_12_jam_libur_SAM); ?></td>-->
                ...
                <td align="center">
                    <?php
                    $sisakartu_kerja_salesman_sample = max(0,$total_SALESMAN_SAMPLE - ($total_SALESMAN_SAMPLE_12_JAMSAM+$total_not_achieved_SAM));
                ...
                <td align="center">
                    <?php
                    if ($total_SALESMAN_SAMPLE > 0) {
                        $persentase_tidak_tercapai_proses_SAM = ($total_not_achieved_SAM / $total_SALESMAN_SAMPLE) * 100;
                ...
                <td align="center">
                    <?php
                    if ($total_SALESMAN_SAMPLE > 0) {
                        $percentage_sample = ($sisakartu_kerja_salesman_sample / $total_SALESMAN_SAMPLE) * 100;
				...
				<td align="center"><?php
                    if ($total_SALESMAN_SAMPLE > 0) {
                        $percentage_sample_tercapai = ($total_SALESMAN_SAMPLE_12_JAMSAM / $total_SALESMAN_SAMPLE) * 100;
            ...
            <!--            <td align="center"><?= htmlspecialchars($total_tidak_tercapai_12_jam_hari_libur_BP); ?></td>-->
                ...
                <td align="center">
                    <?php
                    $sisakartu_kerja_development_sample = max(0,$total_DEVELOPMENT_SAMPLE - ($total_tercapai_12_jamBP+$total_not_achieved_BP));
                ...
                <td align="center">
                    <?php
                    if ($total_DEVELOPMENT_SAMPLE > 0) {
                        $persentase_tidak_tercapai_proses_BP = ($total_not_achieved_BP / $total_DEVELOPMENT_SAMPLE) * 100;
                ...
                <td align="center">
                    <?php
                    if ($total_DEVELOPMENT_SAMPLE > 0) {
                        $percentageDS = ($sisakartu_kerja_development_sample / $total_DEVELOPMENT_SAMPLE) * 100;
				...
				<td align="center"><?php
                    if ($total_DEVELOPMENT_SAMPLE > 0) {
                        $percentageDS_tercapai = ($total_tercapai_12_jamBP / $total_DEVELOPMENT_SAMPLE) * 100;
            ...
            <!--            <td align="center"><?= htmlspecialchars($total_tidak_tercapai_12_jam_hari_libur_RET); ?></td>-->
                ...
                <td align="center"> 
                    <?php
                    $sisakartu_kerja_return = max(0,$total_RETURN - ($total_tercapai_12_jamRET+$total_not_achieved_RET));
                ...
                <td align="center">
                    <?php
                    if ($total_RETURN > 0) {
                        $persentase_tidak_tercapai_prosesRET = ($total_not_achieved_RET / $total_RETURN) * 100;
                ...
                <td align="center">
                    ...
                    <?php
                    if ($total_RETURN > 0) {
                        $percentage_RETURN = ($sisakartu_kerja_return / $total_RETURN) * 100;
				...
				<td align="center"><?php
                    if ($total_RETURN > 0) {
                        $percentage_RETURN_tercapai = ($total_tercapai_12_jamRET / $total_RETURN) * 100;
            ...
            <tr style="font-weight:bold; background-color:yellow;">
                ...
                <td align="center">
                    <?php
                    $total_tidak_tercapai_hari_libur = $total_not_achieved_DOM+$total_not_achieved_REP+$total_not_achieved_MBE+$total_not_achieved_SAM+$total_not_achieved_BP+$total_not_achieved_RET;
                    echo htmlspecialchars($total_tidak_tercapai_hari_libur);
                    ?>
                </td>
                <td align="center">
                    <?php
                    $total_tidak_tercapai = $sisakartu_kerja_biasa+$sisakartu_kerja_ganti_kain+$sisakartu_kerja_mini_bulk+$sisakartu_kerja_salesman_sample+$sisakartu_kerja_development_sample+$sisakartu_kerja_return;
                ...
                <td align="center">
                    ...
                    if ($total_kartu_kerja > 0) {
                        $average_persentase_tidak_tercapai_libur = ($total_tidak_tercapai_hari_libur / $total_kartu_kerja)* 100;
                ...
                <td align="center">
                    ...
                    if ($total_kartu_kerja > 0) {
                        $average_persentase_tidak_tercapai_proses = ($total_tidak_tercapai / $total_kartu_kerja) * 100;
                ...
                <td align="center">
                    ...
                    $average_pencapaian = $total_kartu_kerja > 0 ? ($total_tercapai / $total_kartu_kerja) * 100 : 0;
