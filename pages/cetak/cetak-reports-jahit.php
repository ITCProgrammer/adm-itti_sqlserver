          ...
          <table width="100%" border="0" class="table-list1">
            <tr>
              ...
              border-right:0px #000000 solid;"><strong>
                  <font size="+1">LAPORAN JAHIT DEPARTEMEN CQA</font><br />
      ...
      <tr>
        <td>
          <table width="100%" border="" class="table-list1">
            ...
            <tr>
              <td align="left" style="border: 0; padding: 0; margin: 0;" valign="bottom" width="79%"><strong>
                  <font size="-1">Tanggal : <?php echo date("d F Y", strtotime($_GET['awal'])); ?> s/d <?php echo date("d F Y", strtotime($_GET['akhir'])); ?></font><br />
        ...
        <table width="100%" border="1" class="table-list1">
          ...
          <tbody>
            ...
            $qry1 = sqlsrv_query($cond, "SELECT * FROM db_qc.tbl_jahit
              WHERE CONVERT(date, tgl_jahit) BETWEEN '$Awal' AND '$Akhir' $shft $ord
              ORDER BY id ASC");
