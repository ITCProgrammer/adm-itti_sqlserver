...
<link href="styles_cetak_fin.css" rel="stylesheet" type="text/css">	
...
<table border="0" class="table-list1" width="100%">
  <tbody>
    <tr>
      <td width="76%" rowspan="3" align="center" valign="middle"><font size="+2"><strong>LAPORAN PRODUKSI DEPARTEMEN FINISHING</font><div align="left">TAHUN : <?php echo $_GET['tahun']; ?></div></td>
      <td width="9%" align="center">No. Form</td>
      <td width="15%" align="left">: FW-02-FIN-02</td>
    </tr>
    <tr>
...
<table border="0" class="table-list1" width="100%">
        <thead class="bg-blue">
          <tr>
            <td rowspan="3" align="center" valign="middle"><strong>BULAN</strong></td>
            <td colspan="14" align="center" valign="middle"><strong>MESIN STENTER</strong></td>
            <td colspan="11" align="center" valign="middle"><strong>MESIN NON STENTER</strong></td>
            <td colspan="3" align="center" valign="middle"><strong>TOTAL PRODUKSI KESELURUHAN</strong></td>
          </tr>
          <tr>
            <td rowspan="2" align="center" valign="middle"><strong>FINISHING AKHIR (A)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>PRESET (B)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>TARIK LEBAR (C)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>FIN 1X (D)</strong></td>
            <td colspan="5" align="center" valign="middle"><strong>OVEN</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>NAIK SUHU (J)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>PADDER (K)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>POTONG PINGGIR (L)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>FIN ULANG (M)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>TOTAL PRODUKSI STENTER</strong></td>
            <td colspan="3" align="center" valign="middle"><strong>COMPACT</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>BELAH (P)</strong></td>
            <td colspan="5" align="center" valign="middle"><strong>OVEN</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>LIPAT (U)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>STEAMER (V)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>KAIN JADI<br />
            (A+K+L+M+N+O+Q)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>LOSS<br />
            (C+F+G+I+K+M+O+S)</strong></td>
            <td rowspan="2" align="center" valign="middle"><strong>Total Ganti Kain</strong></td>
          </tr>
          <tr>
            <td align="center" valign="middle"><strong>OVEN STENTER FLEECE (E)</strong></td>
            <td align="center" valign="middle"><strong>OVEN FLEECE ULANG (F)</strong></td>
            <td align="center" valign="middle"><strong>OVEN STENTER ULANG (G)</strong></td>
            <td align="center" valign="middle"><strong>OVEN STENTER (H)</strong></td>
            <td align="center" valign="middle"><strong>OVEN STENTER DYEING (I)</strong></td>
            <td align="center" valign="middle"><strong>NORMAL (N)</strong></td>
            <td align="center" valign="middle"><strong>COMPACT PERBAIKAN (O)</strong></td>
            <td align="center" valign="middle"><strong>TOTAL PRODUKSI COMPACT</strong></td>
            <td align="center" valign="middle"><strong>OVEN KRAGH (Q)</strong></td>
            <td align="center" valign="middle"><strong>OVEN KERING ( R )</strong></td>
            <td align="center" valign="middle"><strong>OVEN DYEING (S)</strong></td>
            <td align="center" valign="middle"><strong>F 1X OVEN FONG (T)</strong></td>
            <td align="center" valign="middle"><strong>TOTAL PRODUKSI OVEN</strong></td>
          </tr>
        </thead>
        <tbody>
          <tr>
...
<table border="0" class="table-list1" width="100%" >
        <thead class="bg-blue">
          <tr>
            <td colspan="17" align="center" valign="middle"><strong>Stopage Machine</strong></td>
          </tr>
          <tr>
            <td align="center" valign="middle"><strong>Mesin</strong></td>
            <td align="center"><strong>Total Kerja Mesin</strong></td>
            <td align="center"><strong>Pemeliharaan Mesin</strong></td>
            <td align="center"><strong>Ganti Lebar</strong></td>
            <td align="center"><strong>Naik Suhu</strong></td>
            <td align="center"><strong>Turun Suhu</strong></td>
            <td align="center"><strong>Pembersihan Teknis</strong></td>
            <td align="center"><strong>Tunggu</strong></td>
            <td align="center"><strong>Persiapan Pot. Pinggir</strong></td>
            <td align="center"><strong>Persiapan Lem Pinggir</strong></td>
            <td align="center"><strong>Kerusakan Mesin</strong></td>
            <td align="center"><strong>Listrik Mati</strong></td>
            <td align="center"><strong>Gangguan Teknis</strong></td>
            <td align="center"><strong>Kurang Personel</strong></td>
            <td align="center"><strong>Kurang Order</strong></td>
            <td align="center"><strong>Total Stop Mesin</strong></td>
            <td align="center"><strong>Persentase Stop Mesin %</strong></td>
          </tr>
        </thead>
        <tbody>
		  <?php
...
<table border="0" class="table-list1" width="100%">
        <thead class="bg-green">
          <tr>
            <td colspan="40" align="center" valign="middle"><strong>PRODUKSI / MESIN</strong></td>
          </tr>
          <tr>
            <td rowspan="2" align="center" valign="middle"><strong>Mesin</strong></td>
            <td colspan="13" align="center" valign="middle"><strong>Kgs</strong></td>
            <td colspan="13" align="center" valign="middle"><strong>Yards</strong></td>
            <td colspan="13" align="center" valign="middle"><strong>Yards / Menit</strong></td>
          </tr>
          <tr>
            <td align="center" valign="middle"><strong>
            <?= substr($tahunSebelumnya, 0); ?>
            </strong></td>
            <td align="center" valign="middle"><strong>JAN</strong></td>
            <td align="center" valign="middle"><strong>FEB</strong></td>
            <td align="center" valign="middle"><strong>MAR</strong></td>
            <td align="center" valign="middle"><strong>APR</strong></td>
            <td align="center" valign="middle"><strong>MEI</strong></td>
            <td align="center" valign="middle"><strong>JUN</strong></td>
            <td align="center" valign="middle"><strong>JUL</strong></td>
            <td align="center" valign="middle"><strong>AGUST</strong></td>
            <td align="center" valign="middle"><strong>SEPT</strong></td>
            <td align="center" valign="middle"><strong>OKT</strong></td>
            <td align="center" valign="middle"><strong>NOV</strong></td>
            <td align="center" valign="middle"><strong>DES</strong></td>
            <td align="center" valign="middle"><strong>
            <?= substr($tahunSebelumnya, 0); ?>
            </strong></td>
            <td align="center" valign="middle"><strong>JAN</strong></td>
        ...
        <tbody>
		  <?php
			...
			LEFT JOIN db_finishing.tbl_no_mesin b 
				ON a.no_mesin = b.no_mesin
			WHERE MONTH(a.tgl_update) = '11' AND YEAR(a.tgl_update) = '$tahun'");
  ...
  <tbody>
    <tr>
      <td width="73%" align="left" valign="top">
        ...
        <thead class="bg-blue">
          <tr>
            <td colspan="2" align="center" valign="middle"><strong>PER SHIFT</strong></td>
            <td align="center"><strong>QTY</strong></td>
            <td align="center"><strong>NCP</strong></td>
            <td align="center"><strong>KAIN JADI</strong></td>
            <td align="center"><strong>NON JADI</strong></td>
            <td align="center"><strong>LOT</strong></td>
            <td align="center"><strong>TOTAL POINT</strong></td>
            <td align="center"><strong>TOTAL MC JALAN</strong></td>
            <td align="center"><strong>TOTAL HARI KERJA</strong></td>
            <td align="center"><strong>POINT AKHIR</strong></td>
            </tr>
        </thead>
        <tbody>
		 <?php
...
//			$dts_K_compact_dyeSHF	= sqlsrv_fetch_array($sqlsK_compact_dyeSHF, SQLSRV_FETCH_ASSOC);
          ...
          <tr>
            ...
            <td align="right"><input name="totpoint" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            <td align="right"><?= number_format($dts_TotMC['t_mc_B'],0); ?></td>
            <td align="right"><input name="totpoint5" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            <td align="right"><input name="totpoint9" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            </tr>
          <tr>
            ...
            <td align="right"><input name="totpoint2" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            <td align="right"><?= number_format($dts_TotMC['t_mc_A'],0); ?></td>
            <td align="right"><input name="totpoint6" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            <td align="right"><input name="totpoint10" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            </tr>
          <tr>
            ...
            <td align="right"><input name="totpoint3" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            <td align="right"><?= number_format($dts_TotMC['t_mc_C'],0); ?></td>
            <td align="right"><input name="totpoint7" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            <td align="right"><input name="totpoint11" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            </tr>
          <tr>
            ...
            <td align="right"><input name="totpoint4" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            <td align="right">&nbsp;</td>
            <td align="right"><input name="totpoint8" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            <td align="right"><input name="totpoint12" type="text" placeholder="0" size="5" maxlength="4" class="tombolkanan" /></td>
            </tr>
        </tbody>
		<tfoot>
		</tfoot>  
...
<table border="0" class="table-list1" width="100%">
  <tbody>
    ...
    <tr>
      <td>&nbsp;</td>
      <td align="center" valign="middle"><strong>Dibuat Oleh:</strong></td>
      <td align="center" valign="middle"><strong>Diperiksa Oleh:</strong></td>
      <td colspan="8" align="center" valign="middle"><strong>Diketahui Oleh:</strong></td>
    </tr>
    <tr>
      <td><strong>Nama</strong></td>
      <td align="center" valign="middle"><input name=nama type=text placeholder="Ketik disini" size="33" maxlength="30"></td>
      <td align="center" valign="middle"><input name="nama4" type="text" placeholder="Ketik disini" size="33" maxlength="30" /></td>
      <td colspan="8" align="center" valign="middle"><input name="nama7" type="text" placeholder="Ketik disini" size="33" maxlength="30" /></td>
    </tr>
    <tr>
      <td><strong>Jabatan</strong></td>
      <td align="center" valign="middle"><input name="nama2" type="text" placeholder="Ketik disini" size="33" maxlength="30" /></td>
      <td align="center" valign="middle"><input name="nama5" type="text" placeholder="Ketik disini" size="33" maxlength="30" /></td>
      <td colspan="8" align="center" valign="middle"><input name="nama8" type="text" placeholder="Ketik disini" size="33" maxlength="30" /></td>
    </tr>
    <tr>
      <td><strong>Tanggal</strong></td>
      <td align="center" valign="middle"><input name="nama3" type="text" placeholder="Ketik disini" size="33" maxlength="30" /></td>
      <td align="center" valign="middle"><input name="nama6" type="text" placeholder="Ketik disini" size="33" maxlength="30" /></td>
      <td colspan="8" align="center" valign="middle"><input name="nama9" type="text" placeholder="Ketik disini" size="33" maxlength="30" /></td>
    </tr>
    <tr>
      <td><strong>Tanda Tangan</strong><br>&nbsp;<br>&nbsp;<br>&nbsp;</td>
