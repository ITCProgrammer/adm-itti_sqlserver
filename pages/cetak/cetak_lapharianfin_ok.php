...
$dts_B_sisa	= sqlsrv_fetch_array($sqlB_sisa, SQLSRV_FETCH_ASSOC);			
		?>	
          <tr>  
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['oven_b_basah']+($dt_B_oven['KG']-$dts_B_oven['basah']),2),2);?></td>
          ...
          <tr>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['oven_k_basah']+($dt_B_oven_k['KG']-$dts_B_oven_k['basah']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['oven_b_st_basah']+($dt_B_stenter['KG']-$dts_B_stenter['basah']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['oven_p_dye_basah']+($dt_B_pr_dye['KG']-$dts_B_pr_dye['basah']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['fin_jadi_basah']+($dt_B_fin_jadi['KG']-$dts_B_fin_jadi['basah']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['fin_ul_basah']+($dt_B_fin_ulang['KG']-$dts_B_fin_ulang['basah']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['fin_ul_p_brs_basah']+($dt_B_fin_ulang_BRS['KG']-$dts_B_fin_ulang_BRS['basah']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['fin_ul_p_dye_basah']+($dt_B_fin_ulang_DYE['KG']-$dts_B_fin_ulang_DYE['basah']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['belah_c_basah']+($dt_B_fin_bl['KG']-$dts_B_fin_bl['basah']),2),2);?></td>
...
$dt_K_compact_dye	= db2_fetch_assoc($sqlK_compact_dye);				
		?>	
          <tr>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['steamer_kering']+($dt_K_steamer['KG']-$dts_K_steamer['kering']),2),2);?></td>
          ...
          <tr>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['preset_kering']+($dt_K_preset['KG']-$dts_K_preset['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['fin_1x_kering']+($dt_K_fin_1x['KG']-$dts_K_fin_1x['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['fin_jadi_kering']+($dt_K_fin_jadi['KG']-$dts_K_fin_jadi['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['fin_ul_kering']+($dt_K_fin_ulang['KG']-$dts_K_fin_ulang['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['oven_obat_kering']+($dt_K_padder['KG']-$dts_K_padder['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['padder_kering']+($dt_K_tambah_obat['KG']-$dts_K_tambah_obat['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['tarik_lebar_kering']+($dt_K_tarik['KG']-$dts_K_tarik['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['compact_n_kering']+($dt_K_compact['KG']-$dts_K_compact['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['compact_fin_kering']+($dt_K_compact_fin['KG']-$dts_K_compact_fin['kering']),2),2);?></td>
            ...
            <td align="right" bgcolor="#B9E1F0"><?php echo number_format(round($dts_B_sisa['compact_dye_kering']+($dt_K_compact_dye['KG']-$dts_K_compact_dye['kering']),2),2);?></td>
		...
		<tfoot>
			...
			$total_k_keluar_kg 	= round($dts_K_steamer['kering'],2)+round($dts_K_preset['kering'],2)+round($dts_K_fin_1x['kering'],2)+round($dts_K_fin_jadi['kering'],2)+round($dts_K_fin_ulang['kering'],2)+round($dts_K_padder['kering'],2)+round($dts_K_tarik['kering'],2)+round($dts_K_tambah_obat['kering'],2)+round($dts_K_compact['kering'],2)+round($dts_K_compact_fin['kering'],2)+round($dts_K_compact_dye['kering'],2);
			$total_k_keluar_lot 	= $dts_K_steamer['kering_lot']+$dts_K_preset['kering_lot']+$dts_K_fin_1x['kering_lot']+$dts_K_fin_jadi['kering_lot']+$dts_K_fin_ulang['kering_lot']+$dts_K_padder['kering_lot']+round($dts_K_tarik['kering_lot'],2)+$dts_K_tambah_obat['kering_lot']+$dts_K_compact['kering_lot']+$dts_K_compact_fin['kering_lot']+$dts_K_compact_dye['kering_lot'];
...
$rowd_stmr = sqlsrv_fetch_array($sql_stmr, SQLSRV_FETCH_ASSOC);			
		?>
          ...
          <tr>
            ...
            <td colspan="3" align="center" bgcolor="#FBF330">&nbsp;</td>
            </tr>
        </tbody>
      </table>	  
