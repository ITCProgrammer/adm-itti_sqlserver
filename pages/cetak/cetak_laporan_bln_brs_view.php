...
<?php
        ...
        $Awal = $input . ' 00:00:00';	
        //tahun sebelumnya
		$hari_kerja_query01 = "SELECT COUNT(DISTINCT DATE(tgl_buat)) as jml FROM tbl_produksi 
                                                WHERE YEAR(tgl_buat) = '$tahun_sebelumnya'";
                            $hari_kerja_result01 = mysqli_query($conb, $hari_kerja_query01);
                            $hari_kerja01 = mysqli_fetch_array($hari_kerja_result01); 
		...
		$query_table01="SELECT
                        ...
                        $stmt_qry01 = mysqli_query($conb, $query_table01);
                        $data_table01 = mysqli_fetch_assoc($stmt_qry01);  
		//GANTI KAIN
						//Internal	
		...
		$hari_kerja_query0 = "SELECT COUNT(DISTINCT DATE(tgl_buat)) as jml FROM tbl_produksi 
                                                WHERE YEAR(tgl_buat) = '$tahun_sebelumnya' AND MONTH(tgl_buat) = '12'";
                            $hari_kerja_result0 = mysqli_query($conb, $hari_kerja_query0);
                            $hari_kerja0 = mysqli_fetch_array($hari_kerja_result0); 
		...
		$query_table0="SELECT
                        ...
                        $stmt_qry0 = mysqli_query($conb, $query_table0);
                        $data_table0 = mysqli_fetch_assoc($stmt_qry0); 
		  //GANTI KAIN
						//Internal	
                ...
                for ($bulan = 1; $bulan <= 12; $bulan++) {
                    ...
                    // Jika tanggal di loop masih <= tanggal input, jalankan query
                        ...
                        $data_table1 = mysqli_fetch_assoc($stmt_qry);
							...
							$hari_kerja_query = "
								SELECT 
									DATE_FORMAT(tgl_buat, '%Y-%m-%d') AS tanggal
								FROM 
									tbl_produksi 
								WHERE 
									tgl_buat >= '$start_time' 
							...
							while ($rh_kerja = mysqli_fetch_array($hari_kerja_result)) {
...
//                            $total_kk = $data_table1['total_kk'];
                        ...
                        // Garuk Fleece                        
                                ...
                                $display_fleece = ($data_table1['garuk_fleece'] != 0) ? $data_table1['garuk_fleece'] : '-';
                                echo "<td align='center' style='border: 1px solid black;'>{$display_fleece}</td>";
                                if ($qty_fleece != 0) {
                                $total_garuk_fleece += $data_table1['garuk_fleece'];
                            }
                ...
                ?>
            <td style='border: 1px solid black;' align='center' colspan="3"><strong>&plusmn; %</strong></td>
                <?php
...
//                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($totalJumlahKK ?: '-') . "</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseFleece ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentasePB ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseAP ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseSisir ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentasePBap ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseOVap ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentasePS ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentasePBpc ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseAIRO ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentasePBlain ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseOVaplain ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentasePOL ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseWet ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseTotUL ?: '0') . "%</b></td>";
	  				echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseInt ?: '0') . "%</b></td>";
	  				echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseEks ?: '0') . "%</b></td>";
                    echo "<td align='center' style='border: 1px solid black;'><b>" . ($persentaseproduksi ?: '0') . "%</b></td>";
                ?>
