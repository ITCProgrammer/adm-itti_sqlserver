...
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title"> Filter Laporan Harian Finishing</h3>
...
$dts_B_sisa	= sqlsrv_fetch_array($sqlB_sisa, SQLSRV_FETCH_ASSOC);			
		?>	
          <tr>  
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['oven_b_basah']+($dt_B_oven['KG']-$dts_B_oven['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['oven_b_basah_lot'])+($dt_B_oven['LOT']-$dts_B_oven['basah_lot']); ?></td>
            </tr>
          <tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['oven_k_basah']+($dt_B_oven_k['KG']-$dts_B_oven_k['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['oven_k_basah_lot'])+($dt_B_oven_k['LOT']-$dts_B_oven_k['basah_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['oven_b_st_basah']+($dt_B_stenter['KG']-$dts_B_stenter['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['oven_b_st_basah_lot'])+($dt_B_stenter['LOT']-$dts_B_stenter['basah_lot']); ?></td>
            </tr> 
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['oven_p_dye_basah']+($dt_B_pr_dye['KG']-$dts_B_pr_dye['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['oven_p_dye_basah_lot'])+($dt_B_pr_dye['LOT']-$dts_B_pr_dye['basah_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['fin_jadi_basah']+($dt_B_fin_jadi['KG']-$dts_B_fin_jadi['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['fin_jadi_basah_lot'])+($dt_B_fin_jadi['LOT']-$dts_B_fin_jadi['basah_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['fin_ul_basah']+($dt_B_fin_ulang['KG']-$dts_B_fin_ulang['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['fin_ul_basah_lot'])+($dt_B_fin_ulang['LOT']-$dts_B_fin_ulang['basah_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['fin_ul_p_brs_basah']+($dt_B_fin_ulang_BRS['KG']-$dts_B_fin_ulang_BRS['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['fin_ul_p_brs_basah_lot'])+($dt_B_fin_ulang_BRS['LOT']-$dts_B_fin_ulang_BRS['basah_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['fin_ul_p_dye_basah']+($dt_B_fin_ulang_DYE['KG']-$dts_B_fin_ulang_DYE['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['fin_ul_p_dye_basah_lot'])+($dt_B_fin_ulang_DYE['LOT']-$dts_B_fin_ulang_DYE['basah_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['belah_c_basah']+($dt_B_fin_bl['KG']-$dts_B_fin_bl['basah']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['belah_c_basah_lot'])+($dt_B_fin_bl['LOT']-$dts_B_fin_bl['basah_lot']); ?></td>
            </tr>
        </tbody>
		<tfoot> 
			<?php
...
$sqlsK_preset  = sqlsrv_query($conS, "SELECT
	SUM(CASE WHEN (a.kondisi_kain = 'KERING' OR a.kondisi_kain = 'BASAH') THEN a.qty ELSE 0 END) AS kering,
	SUM(CASE WHEN (a.kondisi_kain = 'KERING' OR a.kondisi_kain = 'BASAH') THEN 1 ELSE 0 END) AS kering_lot,
	SUM(CASE WHEN (a.kondisi_kain = 'KERING' OR a.kondisi_kain = 'BASAH') THEN a.panjang ELSE 0 END) AS yard
FROM
	db_finishing.tbl_produksi a
LEFT JOIN db_finishing.tbl_no_mesin b ON
	a.no_mesin = b.no_mesin
...
WHERE
	CONVERT(DATE, a.tgl_update) BETWEEN '$Awal' AND '$Akhir'
	and a.nama_mesin IN('OVN1','OVN2','OVB1','OVB2')");		
...
$dt_K_compact_dye	= db2_fetch_assoc($sqlK_compact_dye);				
		?>	
          <tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['steamer_kering']+($dt_K_steamer['KG']-$dts_K_steamer['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['steamer_kering_lot'])+($dt_K_steamer['LOT']-$dts_K_steamer['kering_lot']); ?></td>
            </tr>
          <tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['preset_kering']+($dt_K_preset['KG']-$dts_K_preset['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['preset_kering_lot'])+($dt_K_preset['LOT']-$dts_K_preset['kering_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['fin_1x_kering']+($dt_K_fin_1x['KG']-$dts_K_fin_1x['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['fin_1x_kering_lot'])+($dt_K_fin_1x['LOT']-$dts_K_fin_1x['kering_lot']); ?></td>
            </tr>
			<tr>
			<td align="left">Finishing Jadi</td>
            <td align="left">FNJ1</td>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['fin_jadi_kering']+($dt_K_fin_jadi['KG']-$dts_K_fin_jadi['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['fin_jadi_kering_lot'])+($dt_K_fin_jadi['LOT']-$dts_K_fin_jadi['kering_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['fin_ul_kering']+($dt_K_fin_ulang['KG']-$dts_K_fin_ulang['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['fin_ul_kering_lot'])+($dt_K_fin_ulang['LOT']-$dts_K_fin_ulang['kering_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['oven_obat_kering']+($dt_K_tambah_obat['KG']-$dts_K_tambah_obat['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['oven_obat_kering_lot'])+($dt_K_tambah_obat['LOT']-$dts_K_tambah_obat['kering_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['padder_kering']+($dt_K_padder['KG']-$dts_K_padder['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['padder_kering_lot'])+($dt_K_padder['LOT']-$dts_K_padder['kering_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['pot_pinggir_kering']+($dt_K_pot['KG']-$dts_K_pot['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['pot_pinggir_kering_lot'])+($dt_K_pot['LOT']-$dts_K_pot['kering_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['tarik_lebar_kering']+($dt_K_tarik['KG']-$dts_K_tarik['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['tarik_lebar_kering_lot'])+($dt_K_tarik['LOT']-$dts_K_tarik['kering_lot']); ?></td> 
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['compact_n_kering']+($dt_K_compact['KG']-$dts_K_compact['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['compact_n_kering_lot'])+($dt_K_compact['LOT']-$dts_K_compact['kering_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['compact_fin_kering']+($dt_K_compact_fin['KG']-$dts_K_compact_fin['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['compact_fin_kering_lot'])+($dt_K_compact_fin['LOT']-$dts_K_compact_fin['kering_lot']); ?></td>
            </tr>
			<tr>
            ...
            <td align="right"><?php echo number_format(round($dts_B_sisa['compact_dye_kering']+($dt_K_compact_dye['KG']-$dts_K_compact_dye['kering']),2),2);?></td>
            <td align="center"><?php echo ($dts_B_sisa['compact_dye_kering_lot'])+($dt_K_compact_dye['LOT']-$dts_K_compact_dye['kering_lot']); ?></td>
            </tr>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Data Harian Finishing Mesin Stenter</h3><br>
      ...
      <table class="table table-bordered table-hover table-striped nowrap" id="examplex" style="width:100%">
        <thead class="bg-blue">
          <tr>
            <th rowspan="2"><div align="center">MESIN</div></th>
            <th colspan="4"><div align="center">SHIFT A</div></th>
            <th><div align="center">TOTAL</div></th>
            <th colspan="4"><div align="center">SHIFT B</div></th>
            <th><div align="center">TOTAL</div></th>
            <th colspan="4"><div align="center">SHIFT C</div></th>
            <th><div align="center">TOTAL</div></th>
            <th><div align="center">GRAND TOTAL</div></th>
            <th><div align="center">GRAND TOTAL</div></th>
          </tr>
          <tr>
            <th><div align="center">BASAH</div></th>
            <th><div align="center">LOT</div></th>
            <th><div align="center">KERING</div></th>
            <th><div align="center">LOT</div></th>
...
$rowdS10 = sqlsrv_fetch_array($sqlS10, SQLSRV_FETCH_ASSOC);			
		...
		<tfoot>
            ...
            <td align="center"><?php echo number_format($totalBAST01,2); ?></td>
            <td align="center"><?php echo number_format($totalBAST01_lot,0); ?></td>
            <td align="center"><?php echo number_format($totalKAST01,2); ?></td>
            <td align="center"><?php echo number_format($totalKAST01_lot,0); ?></td>
            <td align="center"><?php echo number_format($totalAST01_yd,2); ?></td>
            <td align="center"><?php echo number_format($totalBBST01,2); ?></td>
            <td align="center"><?php echo number_format($totalBBST01_lot,0); ?></td>
            <td align="center"><?php echo number_format($totalKBST01,2); ?></td>
            <td align="center"><?php echo number_format($totalKBST01_lot,0); ?></td>
            <td align="center"><?php echo number_format($totalBST01_yd,2); ?></td>
            <td align="center"><?php echo number_format($totalBCST01,2); ?></td>
            <td align="center"><?php echo number_format($totalBCST01_lot,0); ?></td>
            <td align="center"><?php echo number_format($totalKCST01,2); ?></td>
            <td align="center"><?php echo number_format($totalKCST01_lot,0); ?></td>
            <td align="center"><?php echo number_format($totalCST01_yd,2); ?></td>
            <td align="center"><?php echo number_format($totalBAST01+$totalBBST01+$totalBCST01+$totalKAST01+$totalKBST01+$totalKCST01,2); ?></td>
            <td align="center"><?php echo number_format($totalAST01_yd+$totalBST01_yd+$totalCST01_yd,2); ?></td>
          </tr>  
		</tfoot>  
      </table>
      </div>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Data Harian Finishing Mesin Oven</h3><br>
        <?php if($_POST['awal']!="") { ?><b>Periode: <?php echo $_POST['awal']." to ".$_POST['akhir']; ?></b>
		<?php } ?>
      <div class="box-body">
      <table class="table table-bordered table-hover table-striped nowrap" id="examplex" style="width:100%">
        <thead class="bg-blue">
          ...
          <tr>
            <th><div align="center">KRAH</div></th>
            <th><div align="center">LOT</div></th>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Data Harian Finishing Mesin Compact</h3>
        <br>
        <?php if($_POST['awal']!="") { ?><b>Periode: <?php echo $_POST['awal']." to ".$_POST['akhir']; ?></b>
		<?php } ?>
      <div class="box-body">
      <table class="table table-bordered table-hover table-striped nowrap" id="examplex" style="width:100%">
        <thead class="bg-blue">
          <tr>
            <th rowspan="2"><div align="center">MESIN</div></th>
            <th colspan="2"><div align="center">SHIFT A</div></th>
            <th><div align="center">TOTAL</div></th>
            <th colspan="2"><div align="center">SHIFT B</div></th>
            <th><div align="center">TOTAL</div></th>
            <th colspan="2"><div align="center">SHIFT C</div></th>
            <th><div align="center">TOTAL</div></th>
            <th><div align="center">GRAND TOTAL</div></th>
            <th><div align="center">GRAND TOTAL</div></th>
          </tr>
...
GROUP BY a.no_mesin");
		...
		<tfoot>  
		  ...
		  <tr>
			<td align="center">TOTAL</td>
            <td align="center"><?php echo number_format($totCPTA_lot,0); ?></td>
            <td align="center"><?php echo number_format($totCPTA_qty,2); ?></td>
            <td align="center"><?php echo number_format($totCPTA_yd,2); ?></td>
            <td align="center"><?php echo number_format($totCPTB_lot,0); ?></td>
            <td align="center"><?php echo number_format($totCPTB_qty,2); ?></td>
            <td align="center"><?php echo number_format($totCPTB_yd,2); ?></td>
            <td align="center"><?php echo number_format($totCPTC_lot,0); ?></td>
            <td align="center"><?php echo number_format($totCPTC_qty,2); ?></td>
            <td align="center"><?php echo number_format($totCPTC_yd,2); ?></td>
            <td align="center"><?php echo number_format($totG_qty,2); ?></td>
            <td align="center"><?php echo number_format($totG_yd,2); ?></td>
          </tr>
		</tfoot>
      </table>
      </div>
...
<div class="row">
  <div class="col-xs-6">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Data Harian Finishing Mesin Belah Cuci</h3>
        <br>
        <?php if($_POST['awal']!="") { ?><b>Periode: <?php echo $_POST['awal']." to ".$_POST['akhir']; ?></b>
		<?php } ?>
      <div class="box-body">
      <table class="table table-bordered table-hover table-striped nowrap" id="examplex" style="width:100%">
        <thead class="bg-blue">
          <tr>
            <th colspan="3"><div align="center">SHIFT</div></th>
            </tr>
          <tr>
...
WHERE
  ...
  <div class="col-xs-6">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Data Harian Finishing Sisa Basah Per Jenis Kain</h3>
        <br>
        <?php if($_POST['awal']!="") { ?><b>Periode: <?php echo $_POST['awal']." to ".$_POST['akhir']; ?></b>
		<?php } ?>
      <div class="box-body">
      <table class="table table-bordered table-hover table-striped nowrap" id="example1" style="width:100%">
        <thead class="bg-blue">
          <tr>
            <th colspan="2"><div align="center">Sisa Basah Per Jenis Kain</div></th>
            </tr>
        </thead>
        <tbody>
          <?php
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Kapasitas dan Produksi Dept Finishing</h3><br>
        <?php if($_POST['awal']!="") { ?><b>Periode: <?php echo $_POST['awal']." to ".$_POST['akhir']; ?></b>
		<?php } ?>
      <div class="box-body">
      <table class="table table-bordered table-hover table-striped nowrap" id="example4" style="width:100%">
        <thead class="bg-blue">
          <tr>
            <th rowspan="2"><div align="center">MESIN</div></th>
            <th colspan="2"><div align="center">KAPASITAS</div></th>
            <th colspan="2"><div align="center">HASIL PRODUKSI</div></th>
            <th colspan="2"><div align="center">PRESENTASE</div></th>
            </tr>
          <tr>
            <th><div align="center">KG</div></th>
            <th><div align="center">YARDS</div></th>
            <th><div align="center">KG</div></th>
            <th><div align="center">YARDS</div></th>
            <th><div align="center">KG</div></th>
            <th><div align="center">YARDS</div></th>
...
LEFT JOIN db_finishing.tbl_no_mesin b ON
	a.no_mesin = b.no_mesin
WHERE
	CONVERT(DATE, a.tgl_update) BETWEEN '$Awal' AND '$Akhir' and a.nama_mesin = 'STM1'
GROUP BY a.no_mesin");
$rowd_stmr = sqlsrv_fetch_array($sql_stmr, SQLSRV_FETCH_ASSOC);			
		?>
          ...
          <tr>
            ...
            <td align="right"><?php echo number_format($total_kg,2);?></td>
            <td align="right"><?php echo number_format($total_yard,2);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="5" align="right">TOTAL PRODUKSI ST+CP+OV</td>
            <td colspan="2" align="left"><?php echo number_format($total_kg-($rowd_stmr['kg']+$rowd_belah['kg']),2);?></td>
            </tr>
          <tr>
