...
$comm_duc = $_POST['value'] ?? '';  // demand terpilih
...
if (mysqli_fetch_assoc($res)) {
    ...
    $q = "UPDATE tbl_firstlot SET comm_duc ='".addslashes($comm_duc)."', lastupdatetime = NOW(), lastupdateuser = '".addslashes($_SESSION['nama10'])."' WHERE demand = '$demand' ";
} else {
    // insert baru
