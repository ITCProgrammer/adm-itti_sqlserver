...
$submit_round = $_POST['value'] ?? '';  // demand terpilih
...
if (mysqli_fetch_assoc($res)) {
    ...
    $q = "UPDATE tbl_firstlot SET submit_round ='".addslashes($submit_round)."', lastupdatetime = NOW(), lastupdateuser = '".addslashes($_SESSION['nama10'])."' WHERE demand = '$demand' ";
} else {
    // insert baru
