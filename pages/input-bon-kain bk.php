...
if($x=="Reject Buyer"){$fk="RB";}else if($x=="Kurang Qty"){$fk="GK";}else if($x=="BS"){$fk="BS";}else if($x=="Oper Warna"){$fk="OW";}else if($x=="Untuk Stock"){$fk="US";}
$format = $fk.date("y/m/");
 ...
 <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="form1">
  ...
  <div class="box-body">
                  ...
                  <div class="col-sm-3">
					...
					<option value="">Pilih</option>
					<?php $sqlw1=mysqli_query($cona,"SELECT warna,nokk FROM tbl_gantikain WHERE no_order='$rCek[no_order]' and no_hanger='$rCek[no_hanger]' GROUP BY warna ORDER BY warna");
...
<thead class="bg-green">
   <tr>
      ...
      <th width="331"><div align="center">Qty Bruto</div></th>
...
<tbody>
  ...
  while($r=mysqli_fetch_array($sql)){
   ...
   <tr bgcolor="<?php echo $bgcolor; ?>">
     ...
     <td align="center"><a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['analisa']; ?>" class="analisa" href="javascipt:void(0)"><?php echo $r['analisa']; ?></a></td>
     <td align="center"><a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['pencegahan']; ?>" class="pencegahan" href="javascipt:void(0)"><?php echo $r['pencegahan']; ?></a></td>
     ...
     <td align="center"><?php if(strtolower($_SESSION['nama10'])=="angela" or $_SESSION['dept10']=="RMP" or $_SESSION['dept10']=="PPC"){ ?>
		 <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['kg_bruto']; ?>" class="kg_bruto" href="javascipt:void(0)"><?php echo $r['kg_bruto']; ?></a><?php }else { echo $r['kg_bruto']; } ?></td>
     <td align="center"><?php if(strtolower($_SESSION['nama10'])=="aressa gasih"){ ?><a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['sts']; ?>" class="sts_bon" href="javascipt:void(0)"><?php echo $r['sts']; ?></a><?php }else{ echo $r['sts'];} ?></td>
