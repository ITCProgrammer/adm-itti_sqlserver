...
$NoDemand	= isset($_POST['no_demand']) ? $_POST['no_demand'] : '';
      ...
      <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
        <div class="box-body">
          ...
          <div class="form-group">
            <label for="no_order" class="col-sm-1 control-label">No Order</label>
              ...
              <div class="col-sm-2">
                <input name="no_demand" type="text" class="form-control pull-right" placeholder="No Demand" value="<?php echo $NoDemand; ?>" />
              </div>			 
          </div>
		  <div class="form-group">
        ...
        <div class="box-footer">
          ...
          <div class="pull-right">
            <input type="button" class="btn btn-block btn-social btn-linkedin btn-sm" <?php if($_SESSION['lvl_id10']=="AFTERSALES"){echo "disabled";}?> name="lihat" value="Kembali" onClick="window.location.href='?p=Input-Lap-Shading'">	   
          </div>
        </div>
        <!-- /.box-footer -->
      </form>
        ...
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
          <thead class="bg-blue">
            <tr>
              ...
              <th><div align="center">Qty BS</div></th>
              ...
              <th><div align="center">Tempat Pengarsipan</div></th>
          ...
          <?php
            ...
            if($Awal!="" or $Langganan!="" or $Item!="" or $Hanger!="" or $Warna!="" or $PO!="" or $Order!=""){
              $qry1=mysqli_query($cond,"SELECT * FROM tbl_lap_shading WHERE DATE_FORMAT( tgl_update, '%Y-%m-%d %H:%i' ) BETWEEN '$start_date' AND '$stop_date' $lgn $noitem $nohanger $wn $nopo $noorder $shft ORDER BY id ASC");
            }else if($NoDemand != ""){
              $qry1=mysqli_query($cond,"SELECT * FROM tbl_lap_shading WHERE nodemand = '$NoDemand' ORDER BY id ASC");
            }else{
              $qry1=mysqli_query($cond,"SELECT * FROM tbl_lap_shading WHERE DATE_FORMAT( tgl_update, '%Y-%m-%d %H:%i' ) BETWEEN '$start_date' AND '$stop_date' $lgn $noitem $nohanger $wn $nopo $noorder $shft ORDER BY id ASC");
            }
          ...
          ?>
            <tr bgcolor="<?php echo $bgcolor; ?>">
              ...
              <a href="#" class="btn btn-danger btn-xs <?php if($_SESSION['akses10']=='biasa' AND ($_SESSION['lvl_id10']!='2' OR $_SESSION['lvl_id']!='NCP')){ echo "disabled"; } ?>" onclick="confirm_delete('./HapusDataShading-<?php echo $row1['id'] ?>');"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Hapus"></i> </a> 
              ...
              <td align="center"><div class="btn-group">
              <a href="?p=Edit-Detail-Roll-Shading&nodemand=<?php echo $row1['nodemand'];?>-<?= date('Y-m-d', strtotime($row1['tgl_buat'])) ?>" class="btn btn-primary btn-xs <?php if($_SESSION['akses10']=='biasa' AND ($_SESSION['lvl_id']!='PACKING' OR $_SESSION['lvl_id']!='NCP')){ echo "disabled"; } ?>"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i> </a>
              </div></td>
              ...
              <td align="center"><a href="#" id='<?php echo $row1['nodemand']; ?>' class="detail_roll_shading"><?php echo $row1['nodemand'];?></a></td>
              ...
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['qty_bs'] ?>" class="qty_bs" href="javascipt:void(0)"><?php echo $row1['qty_bs'] ?></a></td>
              ...
              <td align="center"><a data-pk="<?php echo $row1['id'] ?>" data-value="<?php echo $row1['pengarsipan'] ?>" class="pengarsipan_shading" href="javascipt:void(0)"><?php echo $row1['pengarsipan'] ?></a></td>
...
<div id="DetailRollShading" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>	
