  ...
  <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
    ...
    <div class="box-footer">
      ...
      <div class="pull-right">
        <input type="button" class="btn btn-block btn-social btn-linkedin btn-sm" <?php if($_SESSION['lvl_id']=="AFTERSALES"){echo "disabled";}?> name="lihat" value="Kembali" onClick="window.location.href='?p=Input-Lap-Jahit-New'">	   
      </div>
    </div>
    <!-- /.box-footer -->
  </form>
      ...
      <div class="box-body">
        <table class="table table-bordered table-hover table-striped nowrap" id="example1" style="width:100%">
          ...
          <?php
            ...
            if($Awal!="" and $Akhir!=""){
              $qry1=mysqli_query($cond,"SELECT * FROM tbl_jahit WHERE DATE_FORMAT( tgl_jahit, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' $shft $ord ORDER BY id ASC");
            }else{
              $qry1=mysqli_query($cond,"SELECT * FROM tbl_jahit WHERE DATE_FORMAT( tgl_jahit, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' $shft $ord ORDER BY id ASC");
            }
          ...
          <tr bgcolor="<?php echo $bgcolor; ?>">
            ...
            <a href="#" class="btn btn-danger btn-xs <?php if($_SESSION['akses10']=='biasa' AND ($_SESSION['lvl_id10']!='2')){ echo "disabled"; } ?>" onclick="confirm_delete('./HapusDataJahitNew-<?php echo $row1['id'] ?>');"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Hapus"></i> </a>
            </div></td>
