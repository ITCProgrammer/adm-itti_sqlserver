  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Data Summary Recipe</h3><br>		  
...
<div class="row">
  ...
  <div class="col-lg-6 col-md-12">
    <div class="table-container">
      <h3 class="box-title">Data Summary Jenis Recipe</h3>
      <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
          <thead class="bg-blue">
            <tr>
              <th colspan="5"><div align="center">Jenis Resep % <?= strtoupper(date('M', strtotime($Akhir))); ?></div></th>
            </tr>
            <tr>
              <th><div align="center">Kapasitas Mesin</div></th>
              <th><div align="center">Resep Lama</div></th>
              <th><div align="center">Resep Baru</div></th>
              <th><div align="center">Resep Setting</div></th>
              <th><div align="center">Total Analisa</div></th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td rowspan='2'><div align="center">Total</div></td>
              <td><div align="center"><?= $R_LAMA; ?></div></td>
              <td><div align="center"><?= $R_BARU; ?></div></td>
              <td><div align="center"><?= $R_SETTING; ?></div></td>
              <td rowspan='2'><div align="center"><?= $R_LAMA + $R_BARU + $R_SETTING ?></div></td>
            </tr>
            <tr>
              <td><div align="center"><?= $P_R_LAMA . ' %'; ?></div></td>
              <td><div align="center"><?= $P_R_BARU . ' %'; ?></div></td>
              <td><div align="center"><?= $P_R_SETTING . ' %'; ?></div></td>
            </tr>
            <tr>
              <td rowspan='2'><div align="center">MC &lt; 300</div></td>
              <td><div align="center"><?= $R_LAMA_KECIL; ?></div></td>
              <td><div align="center"><?= $R_BARU_KECIL; ?></div></td>
              <td><div align="center"><?= $R_SETTING_KECIL; ?></div></td>
              <td rowspan='2'><div align="center"><?= $R_LAMA_KECIL + $R_BARU_KECIL + $R_SETTING_KECIL; ?></div></td>
            </tr>
            <tr>
              <td><div align="center"><?= $P_R_LAMA_KECIL . ' %'; ?></div></td>
              <td><div align="center"><?= $P_R_BARU_KECIL . ' %'; ?></div></td>
              <td><div align="center"><?= $P_R_SETTING_KECIL . ' %'; ?></div></td>
            </tr>
            <tr>
              <td rowspan='2'><div align="center">MC &gt; 300</div></td>
              <td><div align="center"><?= $R_LAMA_BESAR; ?></div></td>
              <td><div align="center"><?= $R_BARU_BESAR; ?></div></td>
              <td><div align="center"><?= $R_SETTING_BESAR; ?></div></td>
              <td rowspan='2'><div align="center"><?= $R_LAMA_BESAR + $R_BARU_BESAR + $R_SETTING_BESAR; ?></div></td>
            </tr>
            <tr>
              <td><div align="center"><?= $P_R_LAMA_BESAR . ' %'; ?></div></td>
              <td><div align="center"><?= $P_R_BARU_BESAR . ' %'; ?></div></td>
              <td><div align="center"><?= $P_R_SETTING_BESAR . ' %'; ?></div></td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <div class="col-lg-6 col-md-12">
      <div class="table-container">
          <h3 class="box-title">Data Root Cause Recipe</h3>
          <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped">
                  <thead class="bg-blue">
                      <tr>
                          <th><div align="center">Root Cause &gt; 0x</div></th>
                          <th><div align="center">Total</div></th>
                          <th><div align="center">&gt; 0x (MC &lt; 300)</div></th>
                          <th><div align="center">&gt; 0x (MC &gt; 300)</div></th>
                          <th><div align="center">Total %</div></th>
                          <th><div align="center">&gt; 0x (MC &lt; 300) %</div></th>
                          <th><div align="center">&gt; 0x (MC &gt; 300) %</div></th>
                  ...
                  <tbody>
                    <?php foreach ($rootCauseData as $r): ?>
                        <tr>
                            <td><div align="center"><?= htmlspecialchars($r['name']); ?></div></td>
                            <td><div align="center"><?= $r['total']; ?></div></td>
                            <td><div align="center"><?= $r['kecil']; ?></div></td>
                            <td><div align="center"><?= $r['besar']; ?></div></td>
                            <td><div align="center"><?= $r['p_total']; ?> %</div></td>
                            <td><div align="center"><?= $r['p_kecil']; ?> %</div></td>
                            <td><div align="center"><?= $r['p_besar']; ?> %</div></td>
                        </tr>
                    <?php endforeach; ?>
                  </tbody>
              </table>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <?php
                  ...
                  foreach ($user_lab as $user) {
                      if (trim($user) === '-' || trim($user) === '') continue; // skip user '-'
    ...
    <div class="table-container">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover table-striped">
                <thead class="bg-blue">
                    <tr>
                        <th rowspan="2"><div align="center">RESEP SETTING SESUDAH</div></th>
                        <th colspan="5"><div align="center">BULAN <?= strtoupper(date('M', strtotime($Akhir))); ?></div></th>
                    </tr>
                    <tr>
                        <th><div align="center">TOTAL</div></th>
                ...
                <tbody>
                    <?php
                        $data_sudah = [];
                        foreach($user_sudah as $user):
                        $userKey = str_replace([' ', '.'], ['_', ''], strtoupper($user));
                        $jumlah_ok_sesudah  = $performanceSettingSesudah[$userKey]['OK_SESUDAH'] ?? 0;
                        $jumlah_tok_sesudah = $performanceSettingSesudah[$userKey]['TOK_SESUDAH'] ?? 0;
                        $total_user_sesudah = $performanceSettingSesudah[$userKey]['TOTAL']??0;
                        $data_sudah[] = [
                          'user'        => $user,
                          'total_user'  => $total_user_sesudah
                        ];
                        endforeach;
                        usort($data_sudah, function ($a, $b) {
                            return $b['total_user'] <=> $a['total_user'];
                        });
                    ?>
                    <?php foreach ($data_sudah as $row): ?>
                     <tr>
                          <td align="left"><?= htmlspecialchars($row['user']); ?></td>
                          <td align="center"><?= $row['total_user']; ?></td>
                      </tr>
