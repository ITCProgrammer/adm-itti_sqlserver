<?php
	...
	$sqlCek = mysqli_query($cona, "SELECT * FROM tbl_gantikain WHERE nokk='$nokk' ORDER BY id DESC LIMIT 1");
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="input-group date">
						...
						<input name="tgl_delivery" type="text" class="form-control" id="datepicker" placeholder="Tanggal Delivery" value="<?= $dt_ITXVIEWKK['DELIVERYDATE']; ?><?php if ($cek > 0) {
