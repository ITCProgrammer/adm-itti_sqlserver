...
WHERE
	-- CONVERT(DATE, a.tgl_update) BETWEEN '$Awal' AND '$Akhir' 
  a.tgl_buat BETWEEN '$Awal 23:01:00' AND '$Akhir 23:00:00'
  AND jns_mesin ='oven' 	
GROUP BY a.no_mesin");
