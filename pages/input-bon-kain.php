...
if (isset($_POST['save'])) {
  ...
  $kg1 = (float) str_replace("'", "''", $_POST['kg1']);
  $kg2 = (float) str_replace("'", "''", $_POST['kg2']);
  $kg3 = (float) str_replace("'", "''", $_POST['kg3']);
  $pjg1 = (float) str_replace("'", "''", $_POST['pjg1']);
  $pjg2 = (float) str_replace("'", "''", $_POST['pjg2']);
  $pjg3 = (float) str_replace("'", "''", $_POST['pjg3']);
