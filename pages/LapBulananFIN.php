...
//			SELECT 
//				SUM(CASE WHEN shift='A' THEN berat ELSE 0 END) AS kg_a,
//				SUM(CASE WHEN shift='B' THEN berat ELSE 0 END) AS kg_b,
//				SUM(CASE WHEN shift='C' THEN berat ELSE 0 END) AS kg_c
//			FROM tbl_ncp_qcf_now 
//			WHERE dept='FIN' and ncp_hitung='ya' and no_ncp LIKE '".$Tahun1."/".$Bulan."/%'
//			and not (perbaikan like '%DISPOSISI%' or perbaikan like '%BS%' or perbaikan like '%CUT LOSS%' or perbaikan like '%POTONG BUANG%')
