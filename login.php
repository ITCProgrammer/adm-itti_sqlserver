...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="index.php"><b>Adm</b> ITTI</a>
...
if ($_POST) {
    ...
    $query  = "SELECT TOP 1 * FROM db_adm.tbl_user WHERE username = ? AND password = ?";
    $params = [$username, $password];

    $stmt = sqlsrv_query($cona, $query, $params);

    if ($stmt === false) {
        echo "<script>swal({title:'Error', text:'Query error', type:'error'});</script>";
        exit;
    }
